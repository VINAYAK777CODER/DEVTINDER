...
const userSchema = new mongoose.Schema({
  ...
  emailId: { type: String,unique:true,trim:true, lowercase:true,required:true }, // should not be same
  ...
  photo_url: { type: String, default: "https://www.aquasafemine.com/wp-content/uploads/2018/06/dummy-man-570x570.png" },
